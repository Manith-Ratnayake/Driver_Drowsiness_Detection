...
num_features = model.classifier[0].in_features  # 960
...
path = f"/kaggle/working/MobileNet_v3_Large_epoch_{epochs_resume_no}.pth"
...
for epoch in range(start_epoch, epochs):
    ...
    if accelerator.is_main_process:
        ...
        with open("training_details_MobileNetV3Large_exp2.txt", "a") as f:
            f.write(log_line + "\n")
        ...
        accelerator.save(
            ...
            f"MobileNet_v3_Large_epoch_{epoch}.pth",
        )
