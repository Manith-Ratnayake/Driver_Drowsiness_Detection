...
num_features = model.classifier[2].in_features # Access the last Linear layer
...
path = f"/kaggle/working/ConvNext_Large_epoch_{epochs_resume_no}.pth"
...
for epoch in range(start_epoch, epochs):
    ...
    if accelerator.is_main_process:
        ...
        with open("training_details_ConvNextLarge_exp2.txt", "a") as f:
            f.write(log_line + "\n")
        ...
        accelerator.save(
            ...
            f"ConvNext_Large_epoch_{epoch}.pth",
        )
