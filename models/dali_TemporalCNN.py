...
ENV_PATHS = {
    "Kaggle": {
        "train_1": "/kaggle/input/datasets/manith04/ddd-training1-face",
        "train_2": "/kaggle/input/datasets/manith04/ddd-training2-face",
        "val": "/kaggle/input/datasets/manith04/ddd-validation-face",
    },
    "Colab": {
...
encoder_output_dim=576
encoder_dropout=0.4
temporal_dropout=0.4
tcn_hidden_dim=[256, 256, 256]
...
optimizer = torch.optim.AdamW([
    ...
    {"params": model.tcn.parameters(), "lr": temporal_lr},
